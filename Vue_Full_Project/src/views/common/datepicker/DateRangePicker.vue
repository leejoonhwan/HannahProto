<template>
  <div style="position: relative; display: inline-block;">
    <div class="reportrange-text" @click="togglePicker">
      <slot name="input">
        <span v-if="singleDatePicker">{{startText}}</span>
        <span v-else>{{startText}} - {{endText}}</span>
        <b class="caret"></b>
        <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
      </slot>
    </div>
    <transition name="slide-fade" mode="out-in">
      <div v-if="!singleDatePicker && open" class="daterangepicker dropdown-menu ltr" :class="pickerStyles()" v-on-clickaway="clickAway">
        ...
        <div class="calendar right hidden-xs">
          <div class="calendar-table">
            <calendar :monthDate="nextMonthDate"
                      ...
                      :start="start" :end="end"
                      @nextMonth="nextMonth" @prevMonth="prevMonth"
                      @dateClick="singleDateClick" @hoverDate="hoverDate"
            ></calendar>
          </div>
        </div>
      </div>
